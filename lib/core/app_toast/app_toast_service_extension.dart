...
extension AppToastServiceX on AppToastService {
  void success(String message, {String title = 'Success'}) =>
      show(AppToast(title: title, message: message, type: AppToastType.success));

  void error(String message, {String title = 'Error'}) =>
      show(AppToast(title: title, message: message, type: AppToastType.error));

  void warning(String message, {String title = 'Warning'}) =>
      show(AppToast(title: title, message: message, type: AppToastType.warning));

  void info(String message, {String title = 'Info'}) =>
      show(AppToast(title: title, message: message, type: AppToastType.info));
}
